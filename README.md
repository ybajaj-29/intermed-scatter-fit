...
Instead of by Fourier transform, these functions can also be directly computed from trajectories over the time evolution of an atomistic system in molecular dynamics (MD) simulations.
